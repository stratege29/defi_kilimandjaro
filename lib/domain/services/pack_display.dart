...
/// `^[a-z][a-z0-9_]*_\d{3,4}$`, ex. `culture_ci_221`). Cela permet d'afficher
/// la provenance d'une question **en duel** sans aucune modification backend
/// (le client reçoit déjà le `devinette_id`). L'icône du pack est ensuite
/// rendue via `PackIcon` à partir du `Pack` résolu dans le catalogue.
library;
