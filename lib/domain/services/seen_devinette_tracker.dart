...
///    total du pack, les devinettes déjà vues ne sont jamais resélectionnées.
/// 2. **Éviction FIFO** : dès que le pool non-vu descend sous 20 % du total,
///    les entrées les plus anciennes du set "seen" sont évincées
...
///    (logique alignée avec la PR `feature/loss-economy-rebalance`).
///
...
abstract interface class SeenDevinetteTracker {
  ...
  /// Idempotente : un id déjà présent est promu en tête (mais l'ordre
  /// d'insertion historique reste préservé pour les autres).
  Future<void> markSolved({required String packId, required String devinetteId});
  ...
  /// Utilisé par le bouton « Réinitialiser » du profil.
