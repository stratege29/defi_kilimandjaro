...
class SeenDevinetteStore implements SeenDevinetteTracker {
  ...
  /// monotonie. `0.20` = 20 % minimum de fraîcheur garantie.
  ///
  /// Exposé en `@visibleForTesting` via une getter typed plutôt qu'un
  /// constructeur paramétrique : la valeur est un invariant produit
  /// verrouillé, pas un paramètre de runtime.
  ...
  Future<void> markSolved({
    ...
    list.remove(devinetteId);
    list.add(devinetteId);
